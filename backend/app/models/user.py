...
class User(Base, TimestampMixin):
    ...
    apartments: Mapped[list[UserApartment]] = relationship("UserApartment", back_populates="user", cascade="all, delete-orphan")
    refresh_tokens: Mapped[list[RefreshToken]] = relationship("RefreshToken", back_populates="user", cascade="all, delete-orphan")
    pin: Mapped[UserPin] = relationship("UserPin", back_populates="user", uselist=False, cascade="all, delete-orphan")
